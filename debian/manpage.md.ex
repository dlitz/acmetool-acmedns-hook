% acmetool-acmedns-hook(SECTION) | User Commands
%
% "July 20 2023"
...
acmetool-acmedns-hook - program to do something

# SYNOPSIS

**acmetool-acmedns-hook** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**acmetool-acmedns-hook** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **acmetool-acmedns-hook** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**acmetool-acmedns-hook** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    acmetool-acmedns-hook. See **foo.conf**(5) for further details.
...
**acmetool-acmedns-hook** provides some return codes, that can be used in scripts:
